            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Brand Page</h4>

                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="active">
                                    <a href="{{ route('view_categories') }}" class="btn btn-primary">View All Brands </a>
                                </li>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h1 class="card-title pb-0">Add New Brand</h1>
                        </div>
                        <div class="card-body">
                            <form method="post" action="{{ route('store_brand') }}" enctype="multipart/form-data">
                                @csrf
