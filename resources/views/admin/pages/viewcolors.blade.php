    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Color List</h4>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <h5 class="card-header">View Colors</h5>
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-3">
                                ...
                                <div class="col-9">
                                    ...
                                    <a href="{{ route('add_color') }}" class="btn btn-primary float-end">Add New Color</a>
                                </div>
                            </div>
                                        ...
                                        @foreach ($color as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('delete_color', $item->id) }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Edit Color
                                                            </h5>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="{{ route('update_color') }}" method="POST">
                                                                ...
                                                                <div class="form-floating mb-3">
                                                                    <input type="text" class="form-control"
                                                                        id="floatingInput" value="{{ $item->code }}"
                                                                        name="code">
                                                                    <label for="floatingInput">Color Code</label>
                                                                </div>
            ...
            <script>
                ...
                document.getElementById('applyBulkAction').addEventListener('click', function() {
                    ...
                    if (selectedIds.length > 0) {
                        if (bulkOption === 'delete') {
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    let url = `{{ url('admin/delete-selected-colors') }}`;
                                    fetch(url, {
                                            method: 'POST',
                                            headers: {
                                        ...
                                        .then(data => {
                                            if (data.success) {
                                                ...
                                                Swal.fire(
                                                    'Error!',
                                                    data.message || 'Failed to delete colors.',
                                                    'error'
                                                );
                                            }
                                        })
                            ...
                            Swal.fire({
                                title: `Are you sure you want to ${statusText} selected colors?`,
                                icon: 'warning',
                                showCancelButton: true,
                                confirmButtonColor: '#3085d6',
                                cancelButtonColor: '#d33',
                                ...
                                if (result.isConfirmed) {
                                    let url = `{{ url('admin/update-selected-colors-status') }}`;
                                    fetch(url, {
                                            method: 'POST',
                                            headers: {
                                                'Content-Type': 'application/json',
                                        ...
                                        .then(data => {
                                            if (data.success) {
                                                Swal.fire(
                                                    'Updated!',
                                                    'Colors status successfully updated.',
                                                    'success'
                                                );
                                                setTimeout(() => {
                                                    location.reload();
                                                ...
                                                Swal.fire(
                                                    'Error!',
                                                    data.message || 'Failed to update Color status.',
                                                    'error'
                                                );
                                            }
                                        })
                        ...
                        toastr.warning('No colors selected.');
                    }
                });
            </script>
