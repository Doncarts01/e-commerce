                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class=" text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <!-- Session Status -->
                        <div class="p-3 pt-1">
                            <form method="POST" action="{{ route('admin_forgot_password_submit') }}" class="form-horizontal mt-3">
                                @csrf
                                ...
                                <div class="form-group mb-0 row mt-2">
                                    <div class="col-sm-5 mt-3">
                                        <a href="{{ route('admin_login') }}" class="text-muted"><i class="mdi mdi-account-circle"></i> Back to login</a>
                                    </div>
                                </div>
                            </form>
                        </div>
